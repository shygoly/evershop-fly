...
export default function HelloFloatContent() {
  ...
  const panelStyle = {
    ...
    borderRadius: '12px', boxShadow: '0 12px 32px rgba(0,0,0,0.15)', padding: '14px 16px', zIndex: 9999
  } as React.CSSProperties;
  return (
    <>
      {open && (
        <div style={panelStyle}>
          ...
          <div style={{ fontSize: 14, lineHeight: 1.5 }}>这是一个测试浮窗。组件始终显示在页面右下角。</div>
        </div>
      )}
